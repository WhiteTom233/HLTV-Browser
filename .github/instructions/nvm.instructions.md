---
description: When using node executables, reference to nvm usage
# applyTo: 'When using node executables, reference to nvm usage' # when provided, instructions will automatically be added to the request context when the pattern matches an attached file
---
